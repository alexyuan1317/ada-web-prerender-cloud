...
const lambdaMappings = [
  {
    FunctionName: "Ada-test-Lambda-Edge-Prerendercloud-dev-viewerRequest",
    EventType: "viewer-request",
  },
  {
    FunctionName: "Ada-test-Lambda-Edge-Prerendercloud-dev-originRequest",
    EventType: "origin-request",
  },
  {
    FunctionName: "Ada-test-Lambda-Edge-Prerendercloud-dev-originResponse",
  ...
  getLastPageOfVersions(lambdaMapping)
    .then((res) =>
      res.Versions.reduce((prev, curr) =>
        isNaN(curr.Version) || parseInt(prev.Version) > parseInt(curr.Version)
          ? prev
          : curr
      )
    )
